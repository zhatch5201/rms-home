 ...
 */
interface SelectionModelChangeParams {
    /**
...
declare type SelectionModel = RowId[];
...
declare function useApiRef(apiRefProp: ApiRef | undefined): ApiRef;
...
declare const getLocalization: (translations: Partial<LocaleText>) => Localization;
